...
import main.factory.EnterVotesPageFactory;
import main.factory.ShowPageFactory;
...
public class Controller extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        menuSubtitle.setFont(Font.font("Arial", FontWeight.BOLD, 16));
        ...
        votesButton.setOnAction(eve -> {
            new EnterVotesPageFactory(primaryStage).show();
        ...
        showprojectButton.setOnAction(eve -> {
            new ShowPageFactory(primaryStage).show();
        }); // On Click -> Open the 'Create Project' Stage
        ...
        GridPane.setMargin(quitButton, new Insets(10, 0, 10, 0));

        quitButton.setOnAction(eve -> System.exit(0));//On Click -> exit

        primaryStage.setOnCloseRequest(eve -> Platform.exit());// when clicking cross in window, it will terminate all platforms.
